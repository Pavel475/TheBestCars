...
import { exampleCardsInfo, buttonsAddCard, buttonsRegistry, buttonsSign, cardsList, freshFooterCoordinateValue } from '../scripts/utils/constants.js';
...
function createCard(objectItem) {
    ...
    const cardObject = new Card({
        ...
        getCardImageSrc(imageSrcValue) {
            popupWithImage.changePopupImageSrc(imageSrcValue);
...
const deleteCards = new DeleteCards(scrollY.toggleFixedBlockVisible, scrollY.contentTopCoordinates);
